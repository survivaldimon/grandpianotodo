...
**Acceptance Criteria:**
- [ ] Список с именами
- [ ] Показ количества предоплаченных занятий
- [ ] Индикатор долга (отрицательный баланс) — выделение цветом
- [ ] Поиск по имени
- [ ] Фильтр: все / с долгом / архивированные
- [ ] Tap — переход к профилю ученика
...
- [ ] Показатели:
  ...
  - [ ] Количество отменённых занятий
  - [ ] Общая сумма оплат
  - [ ] Количество учеников с занятиями
  - [ ] Загруженность кабинетов (часы)

### 9.2 Статистика по предметам

**Acceptance Criteria:**
- [ ] Список предметов с количеством занятий за период
- [ ] Доля каждого предмета в общем количестве занятий
- [ ] Детализация по преподавателям внутри предмета

### 9.3 Статистика по преподавателям

**Acceptance Criteria:**
- [ ] Список преподавателей
- [ ] Для каждого: количество занятий за период, предметы
- [ ] Детализация при нажатии

### 9.4 Статистика по ученикам

**Acceptance Criteria:**
- [ ] Топ учеников по количеству занятий
- [ ] Список должников (отрицательный prepaid_lessons_count)

---

## 10. Settings — Настройки

### 10.1 Настройки заведения
...
### 10.4 Типы занятий (Lesson Types)
...
### 10.5 Настройки профиля пользователя
