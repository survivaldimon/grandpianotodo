...
| 1.0.0 (6) | Crash | Flutter 3.38.1 + Xcode 16.2 + **Debug mode** — краш сохранялся |
| 1.0.0 (7) | **SUCCESS** | Flutter 3.38.1 + Xcode 16.2 + **Release mode** — работает! |
...
**Не помогло — Debug mode всё ещё крашился**

**ФИНАЛЬНОЕ РЕШЕНИЕ (сборка 7):**
- Flutter 3.38.1 + Xcode 16.2 + **Release mode**
- Debug билды крашились из-за особенностей debug runtime
- Release билд работает стабильно на iOS 18.x и iOS 26 beta
...
### Codemagic (Default Workflow через UI)
- Flutter: 3.38.1
- Xcode: 16.2
- **Mode: Release** (критично!)
- App Store Connect publishing: включено
