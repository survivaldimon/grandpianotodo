...
class _PaymentsScreenState extends ConsumerState<PaymentsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Итого за период
    final totalAsync = ref.watch(periodTotalProvider(periodParams));
            ...
            child: !canViewAnyPayments
                ...
                : paymentsAsync.when(
                    ...
                    error: (error, _) => ErrorView.fromException(
                      error,
                      onRetry: () => ref.invalidate(paymentsProvider(periodParams)),
                    ),
                    data: (payments) {
                      ...
                      return RefreshIndicator(
                        onRefresh: () async {
                          ref.invalidate(paymentsProvider(periodParams));
                          ref.invalidate(periodTotalProvider(periodParams));
